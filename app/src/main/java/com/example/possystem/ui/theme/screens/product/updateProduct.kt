...
fun UpdateProductScreen(navController: NavController,productId:String) {
    ...
    LaunchedEffect (productId){
        ...
        product = snapshot.getValue(ProductModel::class.java)?.apply {
            id = productId
        }
    }
    if (product==null){
    ...
    var product_name by remember { mutableStateOf(product!!.product_name ?: "") }
